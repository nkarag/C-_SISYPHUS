...
void createDataChunksOfRegion(
                                unsigned int maxDepth, //input
                                unsigned int numFacts,  //input
                                unsigned int numDims,   //input
                                vector<CostNode*>& dataChunksOfRegion //output
                                )
{
        string chunkid("0|0.0|0.0|-1");
        int totcells = 2;
        int rlcells = 1;
        vector<LevelRange> vrng;
        vrng.push_back(LevelRange(string("Location"),string("city"),0,0));
        vrng.push_back(LevelRange(string("PRODUCT"),string("item"),0,1));
        CostNode* nd = createCostNode(
                                        maxDepth,
                                        numFacts,
                                        numDims,
                                        chunkid,
        ...
        dataChunksOfRegion.push_back(nd);

        chunkid = string("0|0.0|0.1|-1");
        totcells = 4;
        rlcells = 4;
        vrng.clear(); // delete previous ranges!
        vrng.push_back(LevelRange(string("Location"),string("city"),1,2));
        vrng.push_back(LevelRange(string("PRODUCT"),string("item"),0,1));
        nd = createCostNode(
                                        maxDepth,
                                        numFacts,
        ...
        chunkid = string("0|0.0|0.2|-1");
        totcells = 4;
        rlcells = 4;
        vrng.clear(); // delete previous ranges!
        vrng.push_back(LevelRange(string("Location"),string("city"),3,4));
        vrng.push_back(LevelRange(string("PRODUCT"),string("item"),0,1));
        nd = createCostNode(
                                        maxDepth,
                                        numFacts,
        ...
        chunkid = string("0|0.0|0.3|-1");
        totcells = 4;
        rlcells = 3;
        vrng.clear(); // delete previous ranges!
        vrng.push_back(LevelRange(string("Location"),string("city"),5,6));
        vrng.push_back(LevelRange(string("PRODUCT"),string("item"),0,1));
        nd = createCostNode(
                                        maxDepth,
                                        numFacts,
        ...
        chunkid = string("0|0.0|0.4|-1");
        totcells = 6;
        rlcells = 4;
        vrng.clear(); // delete previous ranges!
        vrng.push_back(LevelRange(string("Location"),string("city"),7,9));
        vrng.push_back(LevelRange(string("PRODUCT"),string("item"),0,1));
        nd = createCostNode(
                                        maxDepth,
                                        numFacts,
        ...
        chunkid = string("0|0.0|0.5|-1");
        totcells = 6;
        rlcells = 3;
        vrng.clear(); // delete previous ranges!
        vrng.push_back(LevelRange(string("Location"),string("city"),10,12));
        vrng.push_back(LevelRange(string("PRODUCT"),string("item"),0,1));
        nd = createCostNode(
                                        maxDepth,
                                        numFacts,
        ...
        chunkid = string("0|0.0|0.6|-1");
        totcells = 2;
        rlcells = 1;
        vrng.clear(); // delete previous ranges!
        vrng.push_back(LevelRange(string("Location"),string("city"),13,13));
        vrng.push_back(LevelRange(string("PRODUCT"),string("item"),0,1));
        nd = createCostNode(
                                        maxDepth,
                                        numFacts,
        ...
        chunkid = string("0|0.0|0.7|-1");
        totcells = 4;
        rlcells = 2;
        vrng.clear(); // delete previous ranges!
        vrng.push_back(LevelRange(string("Location"),string("city"),14,15));
        vrng.push_back(LevelRange(string("PRODUCT"),string("item"),0,1));
        nd = createCostNode(
                                        maxDepth,
                                        numFacts,
        ...
        chunkid = string("0|0.0|0.8|-1");
        totcells = 6;
        rlcells = 3;
        vrng.clear(); // delete previous ranges!
        vrng.push_back(LevelRange(string("Location"),string("city"),16,18));
        vrng.push_back(LevelRange(string("PRODUCT"),string("item"),0,1));
        nd = createCostNode(
                                        maxDepth,
                                        numFacts,
        ...
        chunkid = string("0|0.0|0.9|-1");
        totcells = 2;
        rlcells = 1;
        vrng.clear(); // delete previous ranges!
        vrng.push_back(LevelRange(string("Location"),string("city"),19,19));
        vrng.push_back(LevelRange(string("PRODUCT"),string("item"),0,1));
        nd = createCostNode(
                                        maxDepth,
                                        numFacts,
        ...
        chunkid = string("0|0.0|0.10|-1");
        totcells = 4;
        rlcells = 2;
        vrng.clear(); // delete previous ranges!
        vrng.push_back(LevelRange(string("Location"),string("city"),20,21));
        vrng.push_back(LevelRange(string("PRODUCT"),string("item"),0,1));
        nd = createCostNode(
                                        maxDepth,
                                        numFacts,
        ...
        chunkid = string("0|0.0|0.11|-1");
        totcells = 2;
        rlcells = 1;
        vrng.clear(); // delete previous ranges!
        vrng.push_back(LevelRange(string("Location"),string("city"),22,22));
        vrng.push_back(LevelRange(string("PRODUCT"),string("item"),0,1));
        nd = createCostNode(
                                        maxDepth,
                                        numFacts,
                        ...
                        string& chunkid, int totcells, int rlcells, vector<LevelRange>& vrange)
{
       //create chunk header
        ...
        //      chunk id
        hdrp->id.setcid(chunkid);
        //      depth
        hdrp->depth = maxDepth;
        //      number of dimensions
        hdrp->numDim = numDims;
        //      total number of cells
        hdrp->totNumCells = totcells;
        //      real num of cells
        hdrp->rlNumCells = rlcells;
...
{
        //print resultMap
        for(map<ChunkID, DirEntry>::const_iterator iter = resultMap.begin();
                                                iter != resultMap.end(); iter++) {
                cout<<"Chunk id: "<<iter->first.getcid()<<", DirEntry: ("<<iter->second.bcktId.rid<<
                        ", "<<iter->second.chnkIndex<<")\n";
        }//for
}//end of printResult
