...
struct BucketHeader {
	 ...
	 * I.e. if p is a pointer pointing at the beginning of the body, then p + dataChnkOffset
	 ...
	 * default constructor
	 */
	BucketHeader() : id(), hdrSz(0), dirSz(0), dataSz(0), bodySz(0), dataChnkOffset(0), recordBdySz(0){}
	/**
	 * constructor
	 */
	BucketHeader(const BucketID& bid,  size_t hd,  size_t dir,  size_t data, size_t bd, size_t off, size_t rb)
		: id(bid),hdrSz(hd),dirSz(dir),dataSz(data),bodySz(bd), dataChnkOffset(off), recordBdySz(rb){}
	/**
	 * copy constructor
	 */
	BucketHeader(const BucketHeader & bh)
		: id(bh.id),hdrSz(bh.hdrSz), dirSz(bh.dirSz), dataSz(bh.dataSz), bodySz(bh.bodySz), dataChnkOffset(bh.dataChnkOffset), recordBdySz(bh.recordBdySz){}
	 ...
	 */
	 size_t getRealDataSz() {
	 	return (recordBdySz-dataChnkOffset);
	 }		
