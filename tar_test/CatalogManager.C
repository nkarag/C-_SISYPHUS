	          ...
	          errorLogStream(errorLogStream)
{
	...
	// MD first
		...
		try {
			...
			ss_m::abort_xct();
			throw; // throw it to the caller (SsmStartupThread.run())
		}
    	} else {
...
void CatalogManager::initMDcatalogMembers()
{
	...
	if(err) {
		...
		error <<"CatalogManager::initMDcatalogMembers ==> "<< err <<endl;
		// throw an exeption
		throw error.str();
	}
	if(!found) {
		throw "CatalogManager::initMDcatalogMembers ==> Cannot find stored cube index by name: unable to use existing catalog";
	}
	...
	if(!found) {
		throw "CatalogManager::initMDcatalogMembers ==>Cannot find stored cube index by id: unable to use existing catalog";
	}
	...
	if(!found) {
		throw "CatalogManager::initMDcatalogMembers ==> Cannot find stored dimension index by name: unable to use existing catalog";
	}
	...
	if(!found) {
		throw "CatalogManager::initMDcatalogMembers ==> Cannot find stored dimension index by id : unable to use existing catalog";
	}
	...
	if(!found) {
		throw "CatalogManager::initMDcatalogMembers ==> Cannot find file with CubeInfo instances  : unable to use existing catalog";
	}
	...
	if(!found) {
		throw "CatalogManager::initMDcatalogMembers ==> Cannot find file with DimInfo instances  : unable to use existing catalog";
	}
...
void CatalogManager::createCatalogMD()
{
	...
	if(err) {
		...
		ostrstream error;
		// Print Shore error message
		error << "CatalogManager::createCatalogMD() ==> Error in creating md database catalog index "<<err <<endl;
		// throw an exeption
		throw error.str();
	}
	...
	if(err) {
		...
		ostrstream error;
		// Print Shore error message
		error <<"CatalogManager::createCatalogMD() ==> Error in creating association in root index "<< err <<endl;
		// throw an exeption
		throw error.str();
	}
	...
	if(err) {
		...
		ostrstream error;
		// Print Shore error message
		error << "CatalogManager::createCatalogMD() ==> Error in creating cube index by name: "<<err <<endl;
		// throw an exeption
		throw error.str();
	}
	...
	if(err) {
		...
		ostrstream error;
		// Print Shore error message
		error <<"CatalogManager::createCatalogMD() ==> Error in creating association in md catalog index: "<< err <<endl;
		// throw an exeption
		throw error.str();
	}
	...
	if(err) {
		...
		ostrstream error;
		// Print Shore error message
		error << "CatalogManager::createCatalogMD() ==> Error in creating cube index by id: "<<err <<endl;
		// throw an exeption
		throw error.str();
	}
	...
	if(err) {
		...
		ostrstream error;
		// Print Shore error message
		error <<"CatalogManager::createCatalogMD() ==> Error in creating association in md catalog indexa #2: "<< err <<endl;
		// throw an exeption
		throw error.str();
	}
	...
	if(err) {
		...
		ostrstream error;
		// Print Shore error message
		error <<"CatalogManager::createCatalogMD() ==> Error in ss_m::create_assoc #3 "<< err <<endl;
		// throw an exeption
		throw error.str();
	}
	...
	if(err) {
		...
		ostrstream error;
		// Print Shore error message
		error << "CatalogManager::createCatalogMD() ==> Error in creating dimension index by name: "<<err <<endl;
		// throw an exeption
		throw error.str();
	}
	...
	if(err) {
		...
		ostrstream error;
		// Print Shore error message
		error <<"CatalogManager::createCatalogMD() ==> Error in creating association in md catalog index #4: "<< err <<endl;
		// throw an exeption
		throw error.str();
	}
	...
	if(err) {
		...
		ostrstream error;
		// Print Shore error message
		error << "CatalogManager::createCatalogMD() ==> Error in creating dimension index by id: "<<err <<endl;
		// throw an exeption
		throw error.str();
	}
	...
	if(err) {
		...
		ostrstream error;
		// Print Shore error message
		error <<"CatalogManager::createCatalogMD() ==> Error in creating association in md catalog indexa #5: "<< err <<endl;
		// throw an exeption
		throw error.str();
	}
	...
	if(err) {
		ostrstream error;
		// Print Shore error message
		error <<"CatalogManager::createCatalogMD() ==> Error in creating Shore file for CubeInfos: " << err <<endl;
		// throw an exception
		throw error.str();
	}
	...
	if(err) {
		...
		ostrstream error;
		// Print Shore error message
		error <<"CatalogManager::createCatalogMD() ==> Error in creating association in md catalog index #6: "<< err <<endl;
		// throw an exeption
		throw error.str();
	}
	...
	if(err) {
		ostrstream error;
		// Print Shore error message
		error <<"CatalogManager::createCatalogMD() ==> Error in creating Shore file for DimInfos: " << err <<endl;
		// throw an exception
		throw error.str();
	}
	...
	if(err) {
		...
		ostrstream error;
		// Print Shore error message
		error <<"CatalogManager::createCatalogMD() ==> Error in creating association in md catalog index #7: "<< err <<endl;
		// throw an exeption
		throw error.str();
	}
...
void CatalogManager::createCatalogREL()
{
	...
	if(err) {
		...
		ostrstream error;
		// Print Shore error message
		error << "CatalogManager::createCatalogREL() ==> Error in creating rel database catalog index "<<err <<endl;
		// throw an exeption
		throw error.str();
	}
	...
	if(err) {
		...
		ostrstream error;
		// Print Shore error message
		error <<"CatalogManager::createCatalogREL() ==> Error in creating association in root index #2 "<< err <<endl;
		// throw an exeption
		throw error.str();
	}
...
void CatalogManager::registerNewCube(CubeInfo& cbinfo)
{
	...
	if(cbinfo.get_cbID() != CubeInfo::null_id) {
		throw "CatalogManager::registerNewCube ==> Tried to register a new cube that its id is not null!";
	}

	if(cubeExists(cbinfo)) {
		throw "CatalogManager::registerNewCube ==> Can't create cube. The cube already exists.";
	}
	...
	if(err) {
		...
		ostrstream error;
		// Print Shore error message
		error <<"CatalogManager::registerNewCube ==> Error in ss_m::create_rec in CatalogManager::registerNewCube "<< err <<endl;
		// throw an exeption
		throw error.str();
	}
	...
	if(err) {
		...
		ostrstream error;
		// Print Shore error message
		error <<"CatalogManager::registerNewCube ==> Error in ss_m::create_assoc in CatalogManager::registerNewCube #1 "<< err <<endl;
		// throw an exeption
		throw error.str();
	}
	...
	if(err) {
		...
		ostrstream error;
		// Print Shore error message
		error <<"CatalogManager::registerNewCube ==> Error in ss_m::create_assoc in CatalogManager::registerNewCube #2 "<< err <<endl;
		// throw an exeption
		throw error.str();
	}
	...
	if(err) {
		...
		ostrstream error;
		// Print Shore error message
		error<<"CatalogManager::registerNewCube ==> Error in ss_m::destroy_assoc in CatalogManager::registerNewCube" << err <<endl;
		// throw an exeption
		throw error.str();
	}
	...
	if(err) {
		...
		ostrstream error;
		// Print Shore error message
		error <<"CatalogManager::registerNewCube ==> Error in ss_m::create_assoc #3 "<< err <<endl;
		// throw an exeption
		throw error.str();
	}
...
cubeID_t CatalogManager::createCubeCode()
{
	...
	if(!found) {
		throw "CatalogManager::createCubeCode ==> Cannot find stored max cube-code: unable to create new cube code";
	}
...
*/
	...
	if(err) {
		...
		ostrstream error;
		// Print Shore error message
		error <<"CatalogManager::cubeExists ==> Error in ss_m::find_assoc in CatalogManager::cubeExists #1 "<< err <<endl;
		// throw an exeption
		throw error.str();
	}
	...
	if(err) {
		...
		ostrstream error;
		// Print Shore error message
		error <<"CatalogManager::cubeExists ==> Error in ss_m::find_assoc in CatalogManager::cubeExists #2 "<< err <<endl;
		// throw an exeption
		throw error.str();
	}
	return (found || found2);
...
void CatalogManager::getCubeInfo(const string& name, CubeInfo& info)
{
	...
	if(err) {
		...
		ostrstream error;
		// Print Shore error message
		error <<"CatalogManager::getCubeInfo ==> Error in ss_m::find_assoc in CatalogManager::getCubeInfo "<< err <<endl;
		// throw an exeption
		throw error.str();
	}
	if(!found) {

		throw "CatalogManager::getCubeInfo ==> specified cube does not exist! ";
	}
	...
	if(err) {
		...
		ostrstream error;
		// Print Shore error message
		error <<"CatalogManager::getCubeInfo ==> Error in pin_i::pin in CatalogManager::getCubeInfo "<< err <<endl;
		// throw an exeption
		throw error.str();
	}
...
void CatalogManager::unregisterCube(const CubeInfo& cbinfo)
{
	...
	if(err) {
		...
		ostrstream error;
		// Print Shore error message
		error <<"CatalogManager::unregisterCube ==> Error in ss_m::find_assoc in CatalogManager::unregisterCube "<< err <<endl;
		// throw an exeption
		throw error.str();
	}
	if(!found) {

		throw "CatalogManager::unregisterCube ==> Exception in CatalogManager::unregisterCube : specified cube does not exist! ";
	}
	...
	if(err) {
		...
		ostrstream error;
		// Print Shore error message
		error<<"Error in ss_m::destroy_assoc in CatalogManager::unregisterCube #1" << err <<endl;
		// throw an exeption
		throw error.str();
	}
	...
	if(err) {
		...
		ostrstream error;
		// Print Shore error message
		error<<"Error in ss_m::destroy_assoc in CatalogManager::unregisterCube #2" << err <<endl;
		// throw an exeption
		throw error.str();
	}
